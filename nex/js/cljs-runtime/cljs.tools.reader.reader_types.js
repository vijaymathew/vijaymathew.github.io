...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6089 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6089(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6090 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6090(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6091 = (function (reader,ch){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6091(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6092 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6092(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6093 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6093(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6094 = (function (reader){
var x__5498__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6094(reader);
}
});
...
var G__6107 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6108 = s.append(c);
c = G__6107;
s = G__6108;
continue;
}
