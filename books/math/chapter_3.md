...
Suppose, for contradiction, that there are only finitely many prime numbers. List them all: p₁, p₂, p₃, ... pₙ. Now consider the number N, formed by multiplying all the primes together and adding 1:
