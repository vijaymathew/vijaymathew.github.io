...
Y at full resolution plus two chroma planes at a quarter each: the image is now described in half as many numbers, before any compression proper has begun. The figure is why this is allowed — and it carries a lesson about meters:
