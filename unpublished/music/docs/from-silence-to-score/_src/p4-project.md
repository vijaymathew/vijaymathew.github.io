...
The shape in {{fig form-little-ternary}} is your target. You have A already; the work of this project is the middle and the return.
...
## P4.3 Compose the contrasting middle
...
{{figure little-tune-b | A contrasting **B section** for the worked piece, in A minor. Against A's gentle, arching C-major tune, this middle is more active and rises higher, and its minor key casts a shadow — a genuine contrast in both colour and character. Crucially, it ends on a **G7 chord** (the dominant of C): a *retransition* that leans back toward home, so that the return of A in the next bar feels prepared and inevitable.}}

Notice the end of {{fig little-tune-b}}: it does not simply stop in A minor but turns, in its last bar, onto the dominant of C — the G7 that pulls back home. This little **retransition** is what makes the return of A land so well; a B section that prepares its own dissolution into the returning A is the mark of a well-joined ternary form.

## P4.4 Bring back the A
...
## P4.5 Connect, refine, and finish
