...
## 26.2 The three parts

The three acts have names: **Exposition**, **Development**, and **Recapitulation**.

{{figure form-sonata | **Sonata form's** three large sections. The **Exposition** presents two theme-groups in two keys — the first at home in the tonic (I), the second *away* in the dominant (V) — establishing a tonal tension. The **Development** takes those themes and works them through many keys, unstable and searching. The **Recapitulation** brings both themes back, but now *both in the tonic* (shown tinted, resolved) — the second theme's homecoming resolves the tension the exposition opened. Statement, conflict, resolution.}}

The heart of the form, and the thing to hold onto, is visible in {{fig form-sonata}}: the second theme is presented *away* from home in the exposition, and *at* home in the recapitulation. That single change — the second theme coming home — is the tonal resolution the whole movement exists to achieve. Everything else serves it.
...
## 26.6 The summit — and the ceiling
...
It is also where I, truthfully, stop teaching you to *compose* — and that is a deliberate choice, not an oversight. Writing a convincing sonata-form movement is an advanced undertaking, demanding a command of long-range pacing and thematic argument that is a whole further course of study. What you *can* now do is enormous: you can **hear** sonata form, follow its three acts and its tonal drama in any first movement you listen to, and understand what the composer is doing and why. And the forms I *do* equip you to compose — binary, ternary, rondo, and variations — are more than enough for real, complete, satisfying music. When you are ready to climb toward sonata form yourself, Appendix D points to the books that take up the ascent.
...
!!! muse "In MuseScore"
    ...
    - **Mark the sections** with rehearsal marks (<kbd>Ctrl</kbd>+<kbd>M</kbd>): find where the **Exposition** ends (often a repeat sign), where the **Development** begins its wandering, and where the **Recapitulation** brings the first theme back in the tonic.
