...
{{shot ms-workspace | The MuseScore editing window with a score open. Learn these regions by name — the menu bar and toolbars across the top, the panel docked at the left, the score itself in the center, and the status bar along the bottom. Everything in this book happens in one of these places.}}
