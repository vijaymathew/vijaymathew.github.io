...
{{figure antiphony | Antiphony between choirs. The **wind choir** (flute and oboe) plays a two-bar phrase — the "call" — while the strings rest; then the **string choir** (violin and cello) "answers" with its own two bars while the winds rest. The two groups toss the music back and forth, each in its own colour, and the alternation gives the passage variety, dialogue, and a sense of space. It is a device you will see constantly once you look for it, and one you can steal for your own scores tomorrow.}}

The antiphony in {{fig antiphony}} is exactly the sort of concrete, portable idea that reading scores gives you: not an abstract principle but a *move* — winds call, strings answer — that you can recognize on the page, understand in a moment, and use yourself. The repertoire is full of such devices: a melody handed from oboe to violin, a pizzicato bass under a wind tune, a string tremolo shimmering beneath a brass chorale, a sudden unison after a rich texture. Collect them as you read.

## 39.5 How to steal well
...
!!! muse "In MuseScore"
    ...
    - **Solo and mute** instruments (the Mixer, <kbd>F10</kbd>) to isolate a line — hear just the melody, just the accompaniment, just the winds — and understand how each layer contributes.
    - **Try a device yourself:** having spotted antiphony ({{fig antiphony}}) or any other move in a score, recreate the *idea* in a short passage of your own — winds calling, strings answering — and play it.

    **Try it:** open any orchestral or chamber score in MuseScore, play it while following along, and answer the six questions of §39.3 for one passage — who has the melody, what the texture is, how it is balanced, what is doubled, how the harmony is spaced, and where the colour changes. Then find one device you like and rebuild it with your own material, as in {{fig antiphony}}. You have just done what every orchestrator does daily; keep doing it, and you will never stop improving.
