...
## 5.2 Note names and the keyboard
...
{{figure treble-lines | The five lines of the treble staff, bottom to top: E4, G4, B4, D5, F5. Generations have remembered them with the sentence "Every Good Boy Does Fine."}}

And the four spaces, bottom to top, spell a word — **F, A, C, E**:

{{figure treble-spaces | The four spaces of the treble staff: F4, A4, C5, E5 — "FACE," conveniently from the bottom up.}}
...
{{figure bass-lines | The five lines of the bass staff: G2, B2, D3, F3, A3 — "Good Boys Do Fine Always."}}

{{figure bass-spaces | The four spaces of the bass staff: A2, C3, E3, G3 — "All Cows Eat Grass."}}
...
## 5.5 Middle C and the grand staff
...
{{figure mc-treble | Middle C written in the treble clef: one ledger line *below* the staff.}}

{{figure mc-bass | The very same pitch — middle C, C4 — written in the bass clef: one ledger line *above* the staff. Two notations, one key on the piano.}}
...
{{figure ledger-below | Descending below the treble staff — D4, C4, B3, A3 — each lower note gathering another ledger line beneath it.}}

{{figure ledger-above | Climbing above the treble staff — G5, A5, B5, C6 — with ledger lines stacking above.}}
...
## 5.7 The black keys: sharps and flats
...
For now, simply notice on {{fig keyboard-octave}} that the two-and-three grouping of black keys is what makes the keyboard legible: the two black keys are always C♯–D♯; the three are always F♯–G♯–A♯. That visual pattern is the reason a pianist can leap to the right note without looking. We will put sharps and flats to real work when we build scales in Chapter 7.

!!! muse "In MuseScore"
    Open MuseScore and start a new score (any instrument — "Piano" is a fine default). To place notes by pitch:

    1. Press <kbd>N</kbd> to enter **note input mode**. The cursor becomes a blue insertion marker.
    2. Choose a duration — press <kbd>5</kbd> for a quarter note (durations are Chapter 6's subject; any will do for now).
    3. Type a letter, <kbd>A</kbd>–<kbd>G</kbd>. MuseScore places that pitch at the octave nearest the previous note.
    4. Nudge a note by an octave with <kbd>Ctrl</kbd>+<kbd>↑</kbd> / <kbd>Ctrl</kbd>+<kbd>↓</kbd>, or by a step with <kbd>↑</kbd> / <kbd>↓</kbd>.
    5. Press <kbd>N</kbd> again (or <kbd>Esc</kbd>) to leave note input.

    To hear the clefs meet, enter middle C, then press <kbd>Ctrl</kbd>+<kbd>↓</kbd> to drop it an octave and watch the notehead cross onto ledger lines. To change a staff's clef, open the **Clefs** palette and double-click a clef onto the staff — the notes stay put in pitch and are simply renamed, exactly as in §5.4. Hover any note and MuseScore names it (e.g. "C4") in the status bar at the bottom of the window.

    **Try it:** enter the eight pitches C4 D4 E4 F4 G4 A4 B4 C5 in order and press <kbd>Space</kbd> to play them back. You have just entered your first scale — the subject of Chapter 7.
