...
{{figure little-tune-orchestra | The Little Tune, orchestrated for a small orchestra (shown at concert pitch). The **melody** is carried by the first violins and doubled an **octave above by the flute**, marked *f*, so it rings out brilliantly on top (Chapters 34, 37). The **inner harmony** — the C · G–C · F–G · C progression the whole tune has always had — is distributed across the oboe, second violins, and violas, marked softer; and the **bass** in the cellos is reinforced by the bassoon, giving it wind weight. The same four bars you met in the Preface, now sounded by a whole orchestra: melody doubled across families, harmony spread through the middle, bass anchored below, and a dynamic gap keeping the tune in front. This is the destination the book has been travelling toward.}}

Study {{fig little-tune-orchestra}} as the sum of everything. The **melody** is doubled across families — first violins plus flute an octave up — for brilliance and strength (Chapter 34), and marked *f* to stay in front (Chapter 37). The **inner voices** of the quartet are handed out among the winds and middle strings, each in a good register (Chapter 33) and marked softer so they support rather than compete. The **bass** gains a bassoon alongside the cellos, a characteristic orchestral reinforcement. Nothing has been *recomposed*; the tune, its harmony, and its bass are exactly what they have always been. What is new is the *scoring* — the choice of who plays what, in what colour, at what weight — and that scoring is orchestration.

## C.4 Make it a whole piece
...
!!! muse "In MuseScore"
    ...
    - **Bring in your piece**: copy the melody, bass, and inner voices from your quartet or piano original onto the appropriate staves, then begin reassigning and doubling — melody to the violins and a flute, bass to the cellos and bassoon, harmony across the middle, as in {{fig little-tune-orchestra}}.
    - **Balance** with written dynamics (melody *f*, accompaniment *p*) and the **Mixer** (<kbd>F10</kbd>); **solo and mute** parts to check each line.
