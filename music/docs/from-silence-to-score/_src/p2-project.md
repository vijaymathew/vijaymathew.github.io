...
{{figure harm-melody | The melody with a chord plan above it, in lead-sheet shorthand (Chapter 13). Each symbol is a chord chosen to fit the melody notes beneath it and to make a satisfying progression: **C–F–G–C–F–C–G–C**, that is I–IV–V–I–IV–I–V–I. Note the ending — G to C, a **V–I authentic cadence** (Chapter 15) — chosen so the phrase closes firmly. This chord plan is the skeleton the four voices will flesh out.}}

The plan in {{fig harm-melody}} is a complete harmonization already, at the lead-sheet level — enough for a guitarist. Notice the choices: the tune's opening C–E–G is plainly the tonic; the A that follows wants a chord containing A, so **F** (IV); the descent in bar 3 is carried by IV–I–V; and the whole thing lands on a **V–I** so it ends like a sentence, not a fragment. Good harmonization is mostly good chord choice, and it starts here, before a single inner voice is written.

## P2.3 Step two — write the bass
...
## P2.4 Step three — fill the inner voices
...
{{figure harm-cadence | The final two chords — V–I — of the harmonization, in four voices. The soprano carries the melody's last two notes, B up to C; the leading tone B resolves to the tonic; the bass leaps from the root G down to C; and the alto and tenor fill the chords with minimal, stepwise motion. The root is doubled in both chords, and there are no parallel fifths or octaves. This is what one moment of the finished harmonization looks like — your task is to realize the whole phrase this way.}}

The cadence in {{fig harm-cadence}} is a single link of the chain, shown complete so you can see the target: four independent lines, every rule from Chapter 14 satisfied, the leading tone rising home. Build the rest of the phrase to the same standard, chord by chord.

## P2.5 Step four — check, refine, and enliven
