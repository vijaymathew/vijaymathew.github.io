...
1. **Choose the ensemble** and open the matching template.
2. **Lay in the structure first** — the melody and the bass, the outer voices that define the piece — on suitable instruments, before filling anything in.
3. **Add the inner harmony**, distributing the middle voices across the remaining instruments in good registers and open spacing.
4. **Decide the texture and colour** for each passage — who has the melody, who accompanies, where to double for strength or blend (Chapter 34).
5. **Balance it** with dynamics, numbers, and register (Chapter 37).
6. **Play it back, listen, and revise** — the step that matters most, and the one only software makes easy.
...
!!! muse "In MuseScore"
    ...
    - **Work outside-in:** enter the melody and bass first on chosen instruments, then fill the inner harmony across the others, as in {{fig chamber-score}}.
